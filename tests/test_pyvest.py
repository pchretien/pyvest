...
class TestS3EventProcessing:
    ...
    def test_process_s3_event_empty_records(self):
        ...
        result = process_s3_event({'Records': []})
...
class TestHarvestPipeline:
    ...
    def test_run_harvest_pipeline_success(
        ...
        """Test run_harvest_pipeline with successful execution."""
        mock_load_config.return_value = mock_config
    ...
    def test_run_harvest_pipeline_missing_config(self, mock_load_config):
        """Test run_harvest_pipeline with missing configuration."""
    ...
    @patch('harvest_processor.get_time_entries')
    @patch('harvest_processor.load_period_entries_from_s3')
    def test_run_harvest_pipeline_api_error(
        self,
        mock_load_s3,
        mock_get_entries,
        mock_load_config,
        ...
        """Test run_harvest_pipeline with API error."""
        mock_load_config.return_value = mock_config
        mock_load_s3.return_value = {}
    ...
    def test_run_harvest_pipeline_missing_aws_config(self, mock_load_config):
        """Test run_harvest_pipeline raises ValueError when AWS config is absent."""
        config_without_aws = {
        ...
        mock_load_config.return_value = config_without_aws
...
class TestConfigurationLoading:
    ...
    def test_load_config_from_file_missing_required_fields(self, tmp_path):
        ...
        config_file = tmp_path / "config.json"
        config_data = {'account_id': 'test_account_id'}  # Missing access_token and harvest_url
        config_file.write_text(json.dumps(config_data))
